...
= Why don't I see the CampTix page in the Dashboard menu? =
The page only appears in the Dashboard menu on individual sites, not in the Network Admin area.

You will also need a Super Admin account to be able to see it; it is not shown to regular administrators.
